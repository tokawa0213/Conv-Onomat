...
def integrate_fin(self):
    for opt in ["mid","line_info_n_k","line_info_n","find_ono_hira","find_ono_kata","line_info","line_info_k"]:
        kata = []
        line_info = []
        mid = []
        hira = []
        ...
        if opt == "find_ono_hira" or opt == "find_ono_kata" or opt == "mid":
            with open("../calculate/all_" + opt_d[opt] + ".csv","a") as f:
