...
def integrate(self):
    for cat in self.theme_list:
        f_name = "../preprocessed_data/csv_pack_" + cat + "/"
        ...
        for csv_cat,st in tqdm(zip([hira,kata,mid,line_info,line_info_n,line_info_k,line_info_n_k],["hira","kata","mid","line_info","line_info_n","line_info_k","line_info_n_k"])):
            df = pd.DataFrame()
