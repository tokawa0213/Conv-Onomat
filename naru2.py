...
genre_list = ["アクション〔文芸〕","コメディー〔文芸〕","VRゲーム〔SF〕","宇宙〔SF〕","空想科学〔SF〕",]
for genre in genre_list:
    ...
    for i in range(1, 101):
        ...
        os.system("python3 ./narouTo2.py " + best1[2:] + " --aozora")

    file_list = glob.glob("narouTo2/*")
    print(file_list)
    ...
    for i in file_list:
        if glob.glob(i) == []:
            ...
            try:
                ...
                ID = i.lstrip("narouTo2/")
                print("Refilled " + ID)
                r = requests.get(url + ID + "/")
                soup = BeautifulSoup(r.content, "html.parser")
                with open("narouTo2/" + ID + "/" + ID, "w") as f:
